...
// =========================================================================
  ...
  public void printGuestReceipt(Reservation reservation) {
    String checkIn = (reservation.getCheckInDate() != null && !reservation.getCheckInDate().isEmpty())
        ? reservation.getCheckInDate()
        : LocalDate.now().toString();
    String checkOut = (reservation.getCheckOutDate() != null && !reservation.getCheckOutDate().isEmpty())
        ? reservation.getCheckOutDate()
        : LocalDate.now().plusDays(reservation.getStayDurationDays()).toString();
    ...
    System.out.println("---------------------------------------------------");
    System.out.printf(" Daily Rate    : RM %-30.2f \n", dailyRate);
    System.out.printf(" TOTAL AMOUNT  : RM %-30.2f \n", reservation.getTotalBillAmount());
  ...
  // =========================================================================
  // REPORT SUB-MENUS & FILTER UI
  // =========================================================================

  public int getReportMainMenuChoice() {
    System.out.println("\n=========================================================================");
    System.out.println("                   FRONT DESK REPORTS & ANALYTICS                        ");
    System.out.println("=========================================================================");
    System.out.println("1. Operational Reservation & Occupancy Filter Report (Search & Sort)");
    System.out.println("2. Business Cycle Revenue & Category Performance Analytics Report");
    System.out.println("0. Back to Front Desk Main Menu");
    System.out.println("=========================================================================");
    return readIntInput("Enter choice (0-2): ", 0, 2);
  }

  public int getReportFilterChoice(String categoryFilter, String statusFilter,
          boolean useMinBill, double minBill, boolean useMinDays, int minDays, String searchKeyword, String sortOrderLabel) {
    System.out.println("\n-------------------------------------------------------------------------");
    System.out.println("         OPERATIONAL RESERVATION REPORT - FILTER & SORT SETTINGS         ");
    System.out.println("-------------------------------------------------------------------------");
    System.out.println("Current Parameters:");
    System.out.println("  1. Room Category Filter  : " + (categoryFilter == null || categoryFilter.isEmpty() ? "ALL" : categoryFilter));
    System.out.println("  2. Status Filter         : " + (statusFilter == null || statusFilter.isEmpty() ? "ALL" : statusFilter));
    System.out.println("  3. Minimum Bill Amount   : " + (useMinBill ? "RM " + String.format("%.2f", minBill) : "None"));
    System.out.println("  4. Minimum Stay Duration : " + (useMinDays ? minDays + " day(s)" : "None"));
    System.out.println("  5. Guest Name Search     : " + (searchKeyword == null || searchKeyword.isEmpty() ? "None (Show All)" : "'" + searchKeyword + "'"));
    System.out.println("  6. Sort Ordering         : " + sortOrderLabel);
    System.out.println("-------------------------------------------------------------------------");
    ...
    System.out.println("5. Set Guest Name Search Filter");
    System.out.println("6. Change Sort Order");
    System.out.println("7. Generate Operational Report Now");
    System.out.println("8. Reset All Filters");
    System.out.println("0. Cancel / Back");
    System.out.println("-------------------------------------------------------------------------");
    return readIntInput("Enter choice (0-8): ", 0, 8);
  }

  public int getReport1SortChoice() {
    System.out.println("\n  Select Sort Ordering:");
    System.out.println("  [1] Confirmation Number (Ascending)");
    System.out.println("  [2] Confirmation Number (Descending)");
    System.out.println("  [3] Guest Name (Alphabetical A-Z)");
    System.out.println("  [4] Stay Duration (Longest to Shortest)");
    System.out.println("  [5] Total Bill Amount (Highest to Lowest)");
    System.out.println("  [6] Total Bill Amount (Lowest to Highest)");
    return readIntInput("  Select sort option (1-6): ", 1, 6);
  }

  public int getBusinessCycleReportChoice(LocalDate startDate, LocalDate endDate, String categoryFilter, double minRevenue, String sortMetricLabel) {
    System.out.println("\n-------------------------------------------------------------------------");
    System.out.println("   BUSINESS CYCLE REVENUE & CATEGORY ANALYTICS - PARAMETERS             ");
    System.out.println("-------------------------------------------------------------------------");
    System.out.println("Current Parameters:");
    System.out.println("  1. Business Cycle Period : " + (startDate != null ? startDate + " to " + endDate : "ALL TIME (No Date Filter)"));
    System.out.println("  2. Room Category Filter  : " + (categoryFilter == null || categoryFilter.isEmpty() ? "ALL CATEGORIES" : categoryFilter));
    System.out.println("  3. Min Revenue Threshold : " + (minRevenue > 0 ? "RM " + String.format("%.2f", minRevenue) : "None"));
    System.out.println("  4. Sort Metric           : " + sortMetricLabel);
    System.out.println("-------------------------------------------------------------------------");
    System.out.println("1. Set Business Cycle Period (Start & End Date)");
    System.out.println("2. Set Category Filter");
    System.out.println("3. Set Minimum Revenue Threshold Filter");
    System.out.println("4. Change Sort Metric");
    System.out.println("5. Generate Business Cycle Analytics Report Now");
    System.out.println("6. Reset All Parameters");
    System.out.println("0. Cancel / Back");
    System.out.println("-------------------------------------------------------------------------");
    return readIntInput("Enter choice (0-6): ", 0, 6);
  }

  public int getBusinessCycleSortChoice() {
    System.out.println("\n  Select Performance Sort Metric:");
    System.out.println("  [1] Total Revenue (Highest to Lowest)");
    System.out.println("  [2] Total Room Nights Sold (Highest to Lowest)");
    System.out.println("  [3] Total Bookings / Volume (Highest to Lowest)");
    System.out.println("  [4] Average Daily Rate (ADR) (Highest to Lowest)");
    return readIntInput("  Select metric option (1-4): ", 1, 4);
  }

  public String inputSearchKeyword() {
    System.out.print("Enter guest name or keyword to search (or press ENTER to clear): ");
    return scanner.nextLine().trim();
  }

  public LocalDate inputReportDate(String prompt) {
    while (true) {
      ...
      try {
        ...
        System.out.println("  [!] Invalid date format. Use YYYY-MM-DD (e.g., 2026-09-01).");
      }
    }
  }
  ...
  public void printReservationDetails(Reservation reservation) {
    ...
    System.out.println("Total Bill:     RM " + String.format("%.2f", reservation.getTotalBillAmount()));
